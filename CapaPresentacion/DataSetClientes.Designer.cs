...
namespace CapaPresentacion {
    ...
    public partial class DataSetClientes : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientesRow AddClientesRow(string nombre, string correo, string telefono, string direccion, System.DateTime fecha_registro, string Estado, string cedula) {
...
namespace CapaPresentacion.DataSetClientesTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([id_cliente] = @Original_id_cliente) AND ([nombre] = @Original_nombre) AND ([correo] = @Original_correo) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ([fecha_registro] = @Original_fecha_registro) AND ([Estado] = @Original_Estado) AND ([cedula] = @Original_cedula))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clientes] ([nombre], [correo], [telefono], [direccion], [fecha_registro], [Estado], [cedula]) VALUES (@nombre, @correo, @telefono, @direccion, @fecha_registro, @Estado, @cedula);
SELECT id_cliente, nombre, correo, telefono, direccion, fecha_registro, Estado, cedula FROM Clientes WHERE (id_cliente = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [nombre] = @nombre, [correo] = @correo, [telefono] = @telefono, [direccion] = @direccion, [fecha_registro] = @fecha_registro, [Estado] = @Estado, [cedula] = @cedula WHERE (([id_cliente] = @Original_id_cliente) AND ([nombre] = @Original_nombre) AND ([correo] = @Original_correo) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ([fecha_registro] = @Original_fecha_registro) AND ([Estado] = @Original_Estado) AND ([cedula] = @Original_cedula));
SELECT id_cliente, nombre, correo, telefono, direccion, fecha_registro, Estado, cedula FROM Clientes WHERE (id_cliente = @id_cliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_cliente, nombre, correo, telefono, direccion, fecha_registro, Estado, c" +
                "edula FROM dbo.Clientes";
        ...
        public virtual int Delete(int Original_id_cliente, string Original_nombre, string Original_correo, string Original_telefono, string Original_direccion, System.DateTime Original_fecha_registro, string Original_Estado, string Original_cedula) {
        ...
        public virtual int Insert(string nombre, string correo, string telefono, string direccion, System.DateTime fecha_registro, string Estado, string cedula) {
            if ((nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string correo, string telefono, string direccion, System.DateTime fecha_registro, string Estado, string cedula, int Original_id_cliente, string Original_nombre, string Original_correo, string Original_telefono, string Original_direccion, System.DateTime Original_fecha_registro, string Original_Estado, string Original_cedula) {
            return this.Update(nombre, correo, telefono, direccion, fecha_registro, Estado, cedula, Original_id_cliente, Original_nombre, Original_correo, Original_telefono, Original_direccion, Original_fecha_registro, Original_Estado, Original_cedula, Original_id_cliente);
        }
    }
