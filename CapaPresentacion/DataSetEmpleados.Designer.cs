...
namespace CapaPresentacion {
    ...
    public partial class DataSetEmpleados : global::System.Data.DataSet {
        ...
        public partial class EmpleadosDataTable : global::System.Data.TypedTableBase<EmpleadosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmpleadosRow AddEmpleadosRow(string nombre, string correo, string cargo, System.DateTime fecha_contratacion, string Estado, string cedula, string telefono) {
...
namespace CapaPresentacion.DataSetEmpleadosTableAdapters {
    ...
    public partial class EmpleadosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Empleados] WHERE (([id_empleado] = @Original_id_empleado) AND ([nombre] = @Original_nombre) AND ([correo] = @Original_correo) AND ([cargo] = @Original_cargo) AND ([fecha_contratacion] = @Original_fecha_contratacion) AND ([Estado] = @Original_Estado) AND ([cedula] = @Original_cedula) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Empleados] ([nombre], [correo], [cargo], [fecha_contratacion], [Estado], [cedula], [telefono]) VALUES (@nombre, @correo, @cargo, @fecha_contratacion, @Estado, @cedula, @telefono);
SELECT id_empleado, nombre, correo, cargo, fecha_contratacion, Estado, cedula, telefono FROM Empleados WHERE (id_empleado = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Empleados] SET [nombre] = @nombre, [correo] = @correo, [cargo] = @cargo, [fecha_contratacion] = @fecha_contratacion, [Estado] = @Estado, [cedula] = @cedula, [telefono] = @telefono WHERE (([id_empleado] = @Original_id_empleado) AND ([nombre] = @Original_nombre) AND ([correo] = @Original_correo) AND ([cargo] = @Original_cargo) AND ([fecha_contratacion] = @Original_fecha_contratacion) AND ([Estado] = @Original_Estado) AND ([cedula] = @Original_cedula) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)));
SELECT id_empleado, nombre, correo, cargo, fecha_contratacion, Estado, cedula, telefono FROM Empleados WHERE (id_empleado = @id_empleado)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_empleado, nombre, correo, cargo, fecha_contratacion, Estado, cedula, te" +
                "lefono FROM dbo.Empleados";
        ...
        public virtual int Delete(int Original_id_empleado, string Original_nombre, string Original_correo, string Original_cargo, System.DateTime Original_fecha_contratacion, string Original_Estado, string Original_cedula, string Original_telefono) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((System.DateTime)(Original_fecha_contratacion));
        ...
        public virtual int Insert(string nombre, string correo, string cargo, System.DateTime fecha_contratacion, string Estado, string cedula, string telefono) {
            if ((nombre == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(fecha_contratacion));
            if ((Estado == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(fecha_contratacion));
            if ((Estado == null)) {
                throw new global::System.ArgumentNullException("Estado");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((System.DateTime)(Original_fecha_contratacion));
            if ((Original_Estado == null)) {
                throw new global::System.ArgumentNullException("Original_Estado");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string correo, string cargo, System.DateTime fecha_contratacion, string Estado, string cedula, string telefono, int Original_id_empleado, string Original_nombre, string Original_correo, string Original_cargo, System.DateTime Original_fecha_contratacion, string Original_Estado, string Original_cedula, string Original_telefono) {
            return this.Update(nombre, correo, cargo, fecha_contratacion, Estado, cedula, telefono, Original_id_empleado, Original_nombre, Original_correo, Original_cargo, Original_fecha_contratacion, Original_Estado, Original_cedula, Original_telefono, Original_id_empleado);
        }
    }
