...
{
    public partial class FConsultaCategorias : Form
    {
        CNCategoria obj = new CNCategoria();
        int indice = 0;

        public FConsultaCategorias()
        {
            InitializeComponent();
            MostrarDatos();
        }
        ...
        private void MostrarDatos()
        {
            try
            {
                ...
                LCantCategoria.Text = Convert.ToString(dgvDatos.RowCount);
            }
            catch (Exception ex)
            {
        ...
        {
            FReporteCategorias frm = new FReporteCategorias();
            frm.ShowDialog();
        }
