...
namespace CapaPresentacion {
    ...
    public partial class DataSetCategorias : global::System.Data.DataSet {
        ...
        public partial class CategoriasDataTable : global::System.Data.TypedTableBase<CategoriasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CategoriasRow AddCategoriasRow(string nombre, string Estado) {
...
namespace CapaPresentacion.DataSetCategoriasTableAdapters {
    ...
    public partial class CategoriasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Categorias] WHERE (([id_categoria] = @Original_id_categoria) A" +
                "ND ([nombre] = @Original_nombre) AND ([Estado] = @Original_Estado))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categorias] ([nombre], [Estado]) VALUES (@nombre, @Estado);\r\nS" +
                "ELECT id_categoria, nombre, Estado FROM Categorias WHERE (id_categoria = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Categorias] SET [nombre] = @nombre, [Estado] = @Estado WHERE (([id_categoria] = @Original_id_categoria) AND ([nombre] = @Original_nombre) AND ([Estado] = @Original_Estado));
SELECT id_categoria, nombre, Estado FROM Categorias WHERE (id_categoria = @id_categoria)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_categoria, nombre, Estado FROM dbo.Categorias";
        ...
        public virtual int Fill(DataSetCategorias.CategoriasDataTable dataTable) {
        ...
        public virtual DataSetCategorias.CategoriasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetCategorias.CategoriasDataTable dataTable = new DataSetCategorias.CategoriasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetCategorias.CategoriasDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_categoria, string Original_nombre, string Original_Estado) {
        ...
        public virtual int Update(string nombre, string Estado, int Original_id_categoria, string Original_nombre, string Original_Estado, int id_categoria) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string Estado, int Original_id_categoria, string Original_nombre, string Original_Estado) {
            return this.Update(nombre, Estado, Original_id_categoria, Original_nombre, Original_Estado, Original_id_categoria);
        }
    }
